<div class="container p-5">
    <div class="row">
        ...
        <div class="col-md-12 p-5">
            <button type="button" class="btn btn-primary mb-2" data-toggle="modal" href="#tambahComplaint">
...
<div class="modal fade" id="tambahComplaint" tabindex="-1" aria-labelledby="tambahComplaintLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="tambahComplaintLabel">Pertanyaan Baru</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body p-5" style="height: 100% !important;">
                <form id="formTambahComplaint" enctype="multipart/form-data">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="btnAddComplaint">Add</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function getData() {
        $('#komplainTable').html('')
        $.ajax({
            url: "<?php echo base_url('home/get_komplain_by_user'); ?>",
            method: "GET",
            dataType: "json",
    ...
    $(document).on('click', '#btnAddComplaint', function(e) {
        var form = $('#formTambahComplaint')[0];
        var formData = new FormData(form);

        $.ajax({
            url: '<?= base_url('home/add_complaint') ?>',
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
